...
RUN java -cp /root/CloudProviderRanker-jar-with-dependencies.jar org.indigo.cloudproviderruleengine.Main /root/sla_priorities.json /root/paasmetric_normalization.json 8443 >> /var/log/CloudProviderRanker.log 2>&1 &
